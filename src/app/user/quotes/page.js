...
export default function UserQuotesPage() {
  ...
  return (
    <main className="p-10 max-w-3xl mx-auto">
      ...
      <section className={`mb-8 p-6 rounded-3xl border ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200 shadow-xl"}`}>
      ...
      <div className="space-y-4">
        {likedQuotes.map((item, index) => (
          <div key={index} className={`p-6 rounded-2xl border ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-100 shadow-sm"}`}>
